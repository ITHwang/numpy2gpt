...
- In `backward(self, gradient: Tensor | None = None, ...)`, `self` should be a scalar, or receive a gradient as the argument. For more details, see [Deep dive into gradients of backward](./docs/deep-dive-into-gradients-of-backward.md).
